            ...
            <div class="contact-form">
                <form @submit.prevent="sendEmail">
                    <div class="form-group">
                        ...
                        <input v-model="form.name" type="text" id="name" name="name" placeholder="Enter your name" required />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea v-model="form.message" id="message" name="message" placeholder="Enter your message" required></textarea>
                    </div>
                    ...
                    <p v-if="error" class="error-msg">❌ Failed to send. Try again later.</p>
                </form>
